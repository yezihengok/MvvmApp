...
public final class FileUtils
{
	...
	public static final String FILE_ROOT = SDCARD_ROOT + "mvvmApp/";
	public static final String FILE = SDCARD_ROOT + "mvvmApp";
	...
	public static void mkdir(Activity context) throws IOException
	{
		...
		if (file.exists()){
			Log.e("FileUtils","文件已存在");
			return;
		}

		if (!file.isDirectory())
			file.mkdirs();
		Log.e("FileUtils","文件创建成功");
	}
