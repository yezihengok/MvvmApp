...
public abstract class MyBaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseMvvmRecyclerHolder> {
    ...
    //构造方法
    public MyBaseRecyclerAdapter(List<T> list, int variableId, Context context, @LayoutRes int layoutId) {
        mContext = context;
        this.list = list;
        mLayoutId = layoutId;
