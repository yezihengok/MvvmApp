 ...
 */
public abstract class BaseMvvmRecyclerAdapter<T> extends RecyclerView.Adapter<BaseMvvmRecyclerHolder> {
    ...
    //构造方法
    public BaseMvvmRecyclerAdapter(List<T> list, int variableId, Context context, @LayoutRes int layoutId) {
        mContext = context;
        this.list = list;
        mLayoutId = layoutId;
